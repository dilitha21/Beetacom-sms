                         ...
                         <div class="card-body p-4 p-md-5">
                            ...
                            <div class="row g-3 mb-4">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" name="batch_year" id="batch_year" maxlength="2" pattern="\d{2}" placeholder="" required class="form-control" value="<?php echo isset($_POST['batch_year']) ? htmlspecialchars($_POST['batch_year']) : ''; ?>" autocomplete="off">
                                </div>
