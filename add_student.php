    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-xl-10">
                ...
                <!-- Registration Card -->
                <div class="form-card">
                    <form action="add_student.php" method="POST" id="studentForm" class="needs-validation" novalidate autocomplete="off">
                        <div class="card-header-custom d-flex justify-content-between align-items-center flex-wrap gap-3">
                         ...
                         <div class="card-body p-4 p-md-5">
                            ...
                            <input type="hidden" id="index_number" name="index_number" value="<?php echo isset($index_number) ? htmlspecialchars($index_number) : ''; ?>">
                            ...
                            <div class="row g-3 mb-4">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" name="batch_year" id="batch_year" maxlength="2" pattern="\d{2}" placeholder="e.g. 26" required class="form-control" value="<?php echo isset($_POST['batch_year']) ? htmlspecialchars($_POST['batch_year']) : ''; ?>" autocomplete="off">
                                </div>
                                <div class="col-md-2" id="nvq_type_container">
                                    ...
                                    <select class="form-select" id="is_nvq" name="is_nvq" required>
                                        ...
                                        <option value="N" <?php echo (isset($_POST['is_nvq']) && $_POST['is_nvq'] === 'N') ? 'selected' : ''; ?>>NVQ</option>
                                    </select>
                                </div>
                                <div class="col-md-2">
                                    <label for="sequence_number" class="form-label required">Index No</label>
                                    <input type="number" class="form-control" id="sequence_number" name="sequence_number" required placeholder="" min="1" value="<?php echo isset($_POST['sequence_number']) ? htmlspecialchars($_POST['sequence_number']) : ''; ?>" autocomplete="off">
                                </div>
                            </div>
                            ...
                            <div class="form-section-title">
                             ...
                             <div class="row g-3 mb-4">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" required placeholder="" value="<?php echo isset($_POST['name']) ? htmlspecialchars($_POST['name']) : ''; ?>" autocomplete="off">
                                </div>
                                <div class="col-md-3">
                                    <label for="nic" class="form-label required">NIC Number</label>
                                    <input type="text" class="form-control" id="nic" name="nic" required placeholder="" pattern="[0-9]{12}" maxlength="12" value="<?php echo isset($_POST['nic']) ? htmlspecialchars($_POST['nic']) : ''; ?>" autocomplete="off">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" id="contact_no" name="contact_no" required placeholder="" pattern="[0-9]{10}" maxlength="10" value="<?php echo isset($_POST['contact_no']) ? htmlspecialchars($_POST['contact_no']) : ''; ?>" autocomplete="off">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="hidden" id="dob" name="dob" value="<?php echo isset($_POST['dob']) ? htmlspecialchars($_POST['dob']) : date('Y-m-d'); ?>">
                                </div>
                                <div class="col-md-2">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="address" name="address" required placeholder="" value="<?php echo isset($_POST['address']) ? htmlspecialchars($_POST['address']) : ''; ?>" autocomplete="off">
                                </div>
                            </div>
                            ...
                            <div class="row g-3 mb-4">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="guardian_name" name="guardian_name" placeholder="" value="<?php echo isset($_POST['guardian_name']) ? htmlspecialchars($_POST['guardian_name']) : ''; ?>" autocomplete="off">
                                </div>
                                <div class="col-md-8">
                                    <label for="guardian_details" class="form-label">Guardian Contact Info / Details</label>
                                    <input type="text" class="form-control" id="guardian_details" name="guardian_details" placeholder="" value="<?php echo isset($_POST['guardian_details']) ? htmlspecialchars($_POST['guardian_details']) : ''; ?>" autocomplete="off">
                                </div>
                            </div>
